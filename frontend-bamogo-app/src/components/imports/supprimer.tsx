...
export default function SupprimerImportModal({ id, isOpen, onClose }: Props) {
    ...
    const action = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const importRequete = await importService.delete(id);

            if (importRequete.status === 200) {

                setError("Import supprimé avec succès");
                setIsLoading(false);
                setSuccess(true);
            ...
            setError("Erreur lors de la suppression de l'import");
            setIsLoading(false);
            setSuccess(false);
        }
    };
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose}>
            ...
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-principal-semi-bold">Supprimer un import</h2>
            ...
            <div className="flex flex-col">
                ...
                <div className={`mb-4 p-3 titre-section-meduim text-(--noir)`}>
                        Voulez-vous vraiment supprimer cet import ?
                    </div>
                ...
                <div className="flex justify-end gap-5 items-center">
                    ...
                    >
                        {isLoading ? "Suppression..." : "Supprimer l'import"}
                    </button>
                </div>
            </div>
