...
export default function SupprimerClientModal({ id, isOpen, onClose }: Props) {
    ...
    const action = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const venteproduitRequete = await clientService.delete(id);

            if (venteproduitRequete.status === 200) {
                console.log("Client supprimé avec succès");

                setError("Client supprimé avec succès");
                setIsLoading(false);
                setSuccess(true);
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose}>
            ...
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-principal-semi-bold">Supprimer un client</h2>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex justify-end gap-5 items-center">
                    ...
                    >
                        {isLoading ? "Suppression..." : "Supprimer le client"}
                    </button>
                </div>
            </div>
