...
export default function SupprimerProduitModal({ id, isOpen, onClose }: Props) {
    ...
    const action = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const venteproduitRequete = await produitService.delete(id);
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose}>
            ...
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-principal-semi-bold">Supprimer un produit</h2>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex justify-end gap-5 items-center">
                    ...
                    >
                        {isLoading ? "Suppression..." : "Supprimer le produit"}
                    </button>
                </div>
            </div>
